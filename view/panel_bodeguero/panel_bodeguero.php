...
<head>
    ...
    <style>
        ...
        .menu-overlay {
            position: fixed; inset: 0; background: transparent; display: none; z-index: 40;
        }
        ...
        html[data-tema="oscuro"] .profile-info h2,
...
<script>
    ...
    const sugerenciasFijas = [
        'Recibir mercancía', 'Mover mercancía', 'Organizar pedidos',
        'Organizar la bodega', 'Control de inventario', 'Reportar novedades'
    ];
